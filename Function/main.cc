...
constexpr uint16_t count_dots_X_Y = 40;
constexpr uint16_t count_dots_Z = 4;
...
constexpr uint32_t COL_DOT = 0xffcfcfcf;
...
int main() {
	...
	for (double step_X = count_dots_X_Y; step_X > -count_dots_X_Y; step_X -= 0.7) {
	...
	for (double stepX = count_dots_X_Y; stepX > -count_dots_X_Y; stepX -= 0.03) {
		for (double stepY = count_dots_X_Y; stepY > -count_dots_X_Y; stepY -= 0.7) {
